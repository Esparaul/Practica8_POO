...
/**
 * Clase Triangulo del paquete claseAbstracta
...
public class Triangulo extends Poligono{
    ...
    */
    ...
    /**
     * Metodo area, sirve para calcular el area del triangulo
     * @return base*altura/2, es de tipo float
     */
    @Override
    public float area(){
    ...
    /**
     * Metodo perimetro, obtendrá el perimetro del triangulo
     * @return a+b+c, es de tipo float
     */
    @Override
